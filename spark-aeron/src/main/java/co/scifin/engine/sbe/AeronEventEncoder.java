...
public class AeronEventEncoder
{
    ...
    private final AeronEventEncoder parentMessage = this;
    ...
    public AeronEventEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public AeronEventEncoder wrapAndApplyHeader(
    ...
    public AeronEventEncoder sequence(final long value)
    {
    ...
    public AeronEventEncoder enumField(final SampleEnum value)
    {
    ...
    public AeronEventEncoder putMessage(final DirectBuffer src, final int srcOffset, final int length)
    {
    ...
    public AeronEventEncoder putMessage(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public AeronEventEncoder message(final String value)
    {
        final byte[] bytes;
        try
        {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final AeronEventDecoder decoder = new AeronEventDecoder();
